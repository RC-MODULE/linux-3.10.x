...
#define VDU_REG_SCALER_V_FLT_ENA_MASK (1 << 17)
#define VDU_REG_SCALER_H_FLT_ENA_MASK (1 << 16)
#define VDU_REG_SCALER_V_SCALER_ENA_MASK (1 << 1)
#define VDU_REG_SCALER_H_SCALER_ENA_MASK (1 << 0)
